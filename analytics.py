"""
analitics module uses pandas dataframe generated by data_cleaner module.
It calculates basic statistics and saves in text format for furthure pdf_creator module usage
"""
import pandas as pd
