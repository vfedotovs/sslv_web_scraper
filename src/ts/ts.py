...
def execute_ogre_task():
    ...
    log.info("HTTP GET http://ws:80/run-task/ogre ")
...
schedule.every().day.at("00:30").do(execute_ogre_task)  # production


while True:
    log.info("ts_loop: checking every 8 hours "
             "if cheduled task needs to run again...")
