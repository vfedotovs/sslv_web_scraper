...
def health_check():
    """
    Basic health check endpoint to verify FastAPI server.
    """
    log.info("Received GET request on /health. Performing health check...")

    health_status = {
        "status": "ok",
        "message": "FastAPI server is ready and healthy.",
        "checks": {},
    }
