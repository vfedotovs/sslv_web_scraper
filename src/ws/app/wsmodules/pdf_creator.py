...
Main module usage is for:
    ...
    6. Save pdf file as {city}_city_report.pdf (or use EMAIL_CITY_TITLE)
"""
...
def pdf_creator_main(city_name: str = None):
    """Main module function. city_name for future multi-city report naming."""
    if city_name:
        log = __import__('logging').getLogger(__name__)
        log.info(f"pdf_creator for city: {city_name}")
